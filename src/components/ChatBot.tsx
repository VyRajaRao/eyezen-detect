...
const FAQ: Record<string, string> = {
  'diseases': "Our AI can help detect several eye conditions, including diabetic retinopathy, glaucoma, cataracts, AMD, hypertension, and myopia. Upload a clear retinal image to get started.",
  'what diseases': "The main conditions analysed by our AI include diabetic retinopathy, glaucoma, cataract, AMD, hypertension, myopia, and other ocular diseases (ODIR-5K categories).",
  'can be detected': "Currently, our AI analyses eight ODIR-5K categories: normal, diabetic retinopathy, glaucoma, cataract, AMD, hypertension, myopia, and other.",
  'detect': "Our AI is designed to analyse diabetic retinopathy, glaucoma, and other conditions. Please upload a retinal image for analysis.",
  ...
  'how does ai work': "Our AI uses a deep learning model (EfficientNet) trained on retinal images via transfer learning. It analyses patterns in your uploaded image to detect signs of various eye diseases. Model performance depends on training data.",
  'how ai works': "Our AI uses transfer learning on EfficientNet to analyse retinal images and detect disease-related patterns.",
  'accuracy': "Model accuracy depends on the training dataset and configuration. Results should always be confirmed by a qualified eye care professional.",
  'ai accuracy': "The AI's accuracy depends on training data. Always consult a doctor for a final diagnosis.",
  ...
  'how to use': "Upload a clear retinal image, wait for the AI to analyse it, and review the results. You can also ask me about eye diseases or the AI itself!",
